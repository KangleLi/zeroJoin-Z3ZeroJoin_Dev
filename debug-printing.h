...
// Printing macros for cluster: RxTx
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_RXTX_CLUSTER)
#define emberAfRxtxClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_RXTX_CLUSTER, __VA_ARGS__)
#define emberAfRxtxClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_RXTX_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfRxtxClusterFlush()
#define emberAfRxtxClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_RXTX_CLUSTER) ) { x; }
#define emberAfRxtxClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_RXTX_CLUSTER, (buffer), (len), (withSpace))
#define emberAfRxtxClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_RXTX_CLUSTER, (buffer))
#else
#define emberAfRxtxClusterPrint(...)
#define emberAfRxtxClusterPrintln(...)
#define emberAfRxtxClusterFlush()
#define emberAfRxtxClusterDebugExec(x)
#define emberAfRxtxClusterPrintBuffer(buffer, len, withSpace)
#define emberAfRxtxClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_RXTX_CLUSTER)
