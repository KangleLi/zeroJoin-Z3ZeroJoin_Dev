...
#define BSP_SERIAL_ASSERT_TX_PORT                (gpioPortF)
#define BSP_SERIAL_ASSERT_TX_LOC                 (24U)

#define BSP_SERIAL_ASSERT_RX_PIN                 (1U)
#define BSP_SERIAL_ASSERT_RX_PORT                (gpioPortF)
#define BSP_SERIAL_ASSERT_RX_LOC                 (24U)
...
#define PORTIO_USART0_RX_PORT                    (gpioPortF)
#define PORTIO_USART0_RX_LOC                     (24U)

#define PORTIO_USART0_TX_PIN                     (0U)
#define PORTIO_USART0_TX_PORT                    (gpioPortF)
#define PORTIO_USART0_TX_LOC                     (24U)

#define HAL_USART0_ENABLE                        (1)

#define BSP_USART0_TX_PIN                        (0U)
#define BSP_USART0_TX_PORT                       (gpioPortF)
#define BSP_USART0_TX_LOC                        (24U)

#define BSP_USART0_RX_PIN                        (1U)
#define BSP_USART0_RX_PORT                       (gpioPortF)
#define BSP_USART0_RX_LOC                        (24U)
